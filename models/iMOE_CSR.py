...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.curve_encoder = CurveEncoder(channels=getattr(args, 'curve_channels', 4))
        self.router_fc = nn.Linear(feature_dim + self.curve_encoder.output_dim, self.num_experts)
